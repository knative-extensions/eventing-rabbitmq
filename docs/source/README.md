...
| `adapterContainerName` \* | Custom name for the receive-adapter container. Defaults to `receive-adapter`. Useful for differentiating log streams across multiple RabbitmqSource instances. |
