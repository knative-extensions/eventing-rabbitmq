...
require (
	...
	knative.dev/eventing v0.18.1-0.20201009000321-2201e0ec3eb2
...
replace (
	...
	github.com/cloudevents/sdk-go/v2 => github.com/cloudevents/sdk-go/v2 v2.3.1-0.20201007130650-8284f5b03573
