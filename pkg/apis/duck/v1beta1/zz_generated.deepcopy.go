...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RabbitAdmin) DeepCopyInto(out *RabbitAdmin) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RabbitAdmin.
func (in *RabbitAdmin) DeepCopy() *RabbitAdmin {
	if in == nil {
		return nil
	}
	out := new(RabbitAdmin)
