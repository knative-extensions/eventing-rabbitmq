...
var condReady = apis.Condition{
	Type:   RabbitmqChannelConditionReady,
	Status: corev1.ConditionTrue,
}

var condDispatcherNotReady = apis.Condition{
	Type:   RabbitmqChannelConditionDispatcherReady,
...
func TestRabbitmqChannelGetConditionSet(t *testing.T) {
	r := &RabbitmqChannel{}
	...
	tests := []struct {
		...
		want: &RabbitmqChannelStatus{
			ChannelableStatus: eventingduckv1.ChannelableStatus{
				Status: duckv1.Status{
					Conditions: []apis.Condition{{
						Type:   RabbitmqChannelConditionAddressable,
						Status: corev1.ConditionUnknown,
					}, {
						Type:   RabbitmqChannelConditionChannelServiceReady,
						Status: corev1.ConditionUnknown,
					}, {
						Type:   RabbitmqChannelConditionDispatcherReady,
						Status: corev1.ConditionUnknown,
					}, {
						Type:   RabbitmqChannelConditionEndpointsReady,
						Status: corev1.ConditionUnknown,
					}, {
						Type:   RabbitmqChannelConditionReady,
						Status: corev1.ConditionUnknown,
					}, {
						Type:   RabbitmqChannelConditionServiceReady,
						Status: corev1.ConditionUnknown,
					}},
				},
			},
...
func TestRabbitmqChannelStatus_SetAddressable(t *testing.T) {
