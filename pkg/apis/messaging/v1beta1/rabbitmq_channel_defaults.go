...
func (c *RabbitmqChannel) SetDefaults(ctx context.Context) {
...
func (cs *RabbitmqChannelSpec) SetDefaults(ctx context.Context) {
	if cs.Config.Namespace == "" {
		cs.Config.Namespace = apis.ParentMeta(ctx).Namespace
	}
}
