...
func createDispatcherDeployment(dlq bool) *appsv1.Deployment {
...
func createQueue(kref *duckv1.KReference, dlq bool) *rabbitv1beta1.Queue {
...
func createBinding(withFilter bool, dlq bool) *rabbitv1beta1.Binding {
