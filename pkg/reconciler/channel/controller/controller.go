...
import (
	...
	"knative.dev/eventing-rabbitmq/pkg/client/injection/informers/messaging/v1beta1/rabbitmqchannel"
...
func NewController(ctx context.Context,  _ configmap.Watcher) *controller.Impl {
	...
	channelInformer := rabbitmqchannel.Get(ctx)
	...
	impl := rabbitmqChannelReconciler.NewImpl(ctx, r)
