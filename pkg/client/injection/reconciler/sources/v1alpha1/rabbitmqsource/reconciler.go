...
// controller reconciling v1alpha1.RabbitmqSource if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.RabbitmqSource.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.RabbitmqSource) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.RabbitmqSource) reconciler.Event
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.RabbitmqSources(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.RabbitmqSource, desired *v1alpha1.RabbitmqSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RabbitmqSource, desiredFinalizers sets.Set[string]) (*v1alpha1.RabbitmqSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.RabbitmqSource, desiredFinalizers sets.Set[string]) (*v1alpha1.RabbitmqSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.RabbitmqSource, desiredFinalizers sets.Set[string]) (*v1alpha1.RabbitmqSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.RabbitmqSource, reconcileEvent reconciler.Event) (*v1alpha1.RabbitmqSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1alpha1().RabbitmqSources(resource.Namespace)
