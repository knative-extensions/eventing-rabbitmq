...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RabbitmqSource, desiredFinalizers sets.String) (*v1alpha1.RabbitmqSource, error) {
	// Don't modify the informers copy.
