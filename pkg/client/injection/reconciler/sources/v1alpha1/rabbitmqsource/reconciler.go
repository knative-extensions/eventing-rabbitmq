...
// controller finalizing v1alpha1.RabbitmqSource if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.RabbitmqSource.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.RabbitmqSource) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.RabbitmqSource, desired *v1alpha1.RabbitmqSource) error {
