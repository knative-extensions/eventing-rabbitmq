...
import (
	...
	externalversions "github.com/rabbitmq/messaging-topology-operator/pkg/generated/informers/externalversions"
	v1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	client "knative.dev/eventing-rabbitmq/pkg/client/injection/rabbitmq.com/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/rabbitmq/messaging-topology-operator/pkg/generated/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
