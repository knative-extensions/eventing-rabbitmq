...
import (
	...
	fake "github.com/rabbitmq/messaging-topology-operator/pkg/generated/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/rabbitmq/messaging-topology-operator/pkg/generated/clientset/versioned/fake.Clientset from context.")
	}
