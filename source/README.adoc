...
| `channel_config.prefetch_count` {optional} | Int that limits the https://www.rabbitmq.com/consumer-prefetch.html[Consumer Prefetch Value]. Default value is 1. A value of 0 will default to 1. Value msut be between 1 and 1000.
