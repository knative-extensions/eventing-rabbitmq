...
func Get(ctx context.Context, selector string) v1beta1.VhostInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-rabbitmq/third_party/pkg/client/informers/externalversions/rabbitmq.com/v1beta1.VhostInformer with selector %s from context.", selector)
	}
