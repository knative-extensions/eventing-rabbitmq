...
func Get(ctx context.Context) v1beta1.ExchangeInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-rabbitmq/third_party/pkg/client/informers/externalversions/rabbitmq.com/v1beta1.ExchangeInformer from context.")
	}
